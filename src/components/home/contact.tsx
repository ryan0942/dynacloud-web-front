...
export function ContactSection() {
  ...
  return (
    <div className="container mx-auto mb-10 px-4 md:px-10">
      ...
      >
        <div className="invisible relative -top-52" id="contact_section" />
        <div className="mb-2 flex items-center justify-center gap-2">
          <span className="block h-0.5 w-5 bg-primary"></span>
          <h2 className="text-sm font-medium text-primary">CONTACT</h2>
          <span className="block h-0.5 w-5 bg-primary"></span>
        </div>
        <AnimatedText
          as="h2"
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        >
          <h3 className="mb-6 text-2xl font-bold">{t("SendUsAMessage")}</h3>
